                                        ...
                                        <select class="form-control" id="region">
                                            ...
                                            @foreach($countries as $country)
                                                @if($country->advertiser_country)
                                                    <option {{ request()->region == $country->advertiser_country ? "selected" : "" }}
                                                        value="{{ $country->advertiser_country }}">
                                                        {{ $country->advertiser_country }}</option>
                                                @endif
                                            @endforeach
                                            <option {{ request()->region == "unknown" ? "selected" : "" }} value="unknown">
                                                Unknown</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select class="form-control" id="sortBy">
                                            <option {{ request()->earning_sort == "advertiser" || empty(request()->earning_sort) ? "selected" : "" }} value="advertiser">
                                                Advertiser</option>
                                            <option {{ request()->earning_sort == "sale" ? "selected" : "" }} value="sale">
                                                Sale</option>
                    ...
                    {{-- <div class="col-lg-3 col-12">
                        <div class="card shadow-sm border-0 rounded-3 sticky-lg-top">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-4 pb-3 border-bottom">
                                    <h6 class="mb-3 fw-semibold d-flex align-items-center">
                                        <i class="fas fa-users me-2 text-muted"></i> Advertiser Region
                                    </h6>
                                    <div class="form-check form-check-inline d-block mb-2">
                                        <select class=" form-control" id="region">
                                            <option {{ request()->region == "all" || empty(request()->region) ? "selected" : "" }} value="all">All Regions</option>
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                                                ...
                                                <li>
                                                    <a class="dropdown-item d-flex align-items-center"
                                                        href="{{ route('publisher.reports.performance-by-transactions.export', array_merge(['type' => 'xlsx'], $queryParams)) }}">
                                                ...
                                                <li>
                                                    <a class="dropdown-item d-flex align-items-center"
                                                        href="{{ route('publisher.reports.performance-by-transactions.export', array_merge(['type' => 'csv'], $queryParams)) }}">
