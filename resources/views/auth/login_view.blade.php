    ...
    <section class="get-started-page">
        <div class="container">
            ...
            <div class="choice-stack">
                <!-- New Here Card -->
                <a href="{{ route('register', ['type' => 'publisher']) }}" class="choice-card" data-aos="fade-up-right" data-aos-delay="150" data-aos-duration="1100"   >
                ...
                <!-- Already Member Card -->
                <a href="{{ route('login', ['type' => 'publisher']) }}" class="choice-card" data-aos="fade-up-left" data-aos-delay="300" data-aos-duration="1100">
                    <div class="choice-icon">
