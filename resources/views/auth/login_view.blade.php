    ...
    <main class="main-content">
        <div class="main-container">
            ...
            <div class="selection-wrapper">
                ...
                <div class="selection-card">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('register', ['type' => 'publisher']) }}" class="btn-card btn-primary-card">
                ...
                <div class="selection-card">
                    ...
                    <div class="card-footer">
                        <a href="{{ route('login', ['type' => 'publisher']) }}" class="btn-card btn-outline-card">
                            Log In to Dashboard
                            <i class="fas fa-arrow-right btn-icon"></i>
                        </a>
                    </div>
            ...
            <div class="footer-section">
                ...
                <p style="margin-top: 10px; font-size: 0.85rem;">&copy; {{ date('Y') }} LinksCircle Affiliate Network. All rights reserved.</p>
            </div>
        </div>
    </main>
