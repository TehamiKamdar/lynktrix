...
<aside class="dashboard-sidebar" id="dashboardSidebar">
    <div class="sidebar-brand">
      <div class="brand-logo">
        <img src="<?php echo e(asset("img/favicon.png")); ?>" class="img-fluid" alt="">
      </div>
    </div>
    ...
    <div class="sidebar-nav">
      <ul class="list-unstyled">
        <li class="nav-item">
          <a href="<?php echo e(route("dashboard", ["type" => "publisher"])); ?>" class="nav-link <?php echo e(Route::is("dashboard", ["type" => "publisher"]) ? "active" : ""); ?>" id="navDashboard">
