        ...
        <table class="table table-hover align-middle modern-table">
            ...
            <tbody>
                <tr>
                    ...
                    <th>
                        <span><?php if(count($transactions)): ?><?php echo e(implode(', ', array_unique($transactions->pluck("sale_amount_currency")->toArray()))); ?> <?php echo e(number_format($totalSaleAmount, 2)); ?> <?php else: ?> $0 <?php endif; ?></span>
                    </th>
                    <th>
                        <span><?php if(count($transactions)): ?><?php echo e(implode(', ', array_unique($transactions->pluck("commission_amount_currency")->toArray()))); ?> <?php echo e(number_format($totalCommissionAmount, 2)); ?> <?php else: ?> $0 <?php endif; ?></span>
                    </th>
                    <th>
...
<?php /**PATH D:\lynktrix\resources\views/template/publisher/reports/transaction/list_view.blade.php ENDPATH**/ ?>