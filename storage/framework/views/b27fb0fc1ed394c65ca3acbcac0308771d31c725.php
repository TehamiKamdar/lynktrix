            ...
            <div class="step-fields">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="company_name" name="company_name"
                        placeholder="Enter company name (Legal)" value="<?php echo e($stepTwo['company_name'] ?? null); ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="contact_name" name="contact_name" placeholder=""
                        value="<?php echo e($stepTwo['contact_name'] ?? null); ?>">
                </div>
                <div class="form-group">
                    ...
                    <input type="tel" class="form-control" id="phone_number" name="phone_number" placeholder=""
                        value="<?php echo e($stepTwo['phone_number'] ?? null); ?>">
                </div>
                <div class="form-group">
                    <div class="countryOption">
                ...
                <div class="form-group">
                    ...
                    <select class="js-example-basic-single js-states form-control" id="state" name="state">
                        ...
                        <?php $__currentLoopData = $states; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $state): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php echo e(isset($stepTwo['state']) && $stepTwo['state'] == $state['id'] ? "selected" : null); ?>

                                value="<?php echo e($state['id']); ?>"><?php echo e(ucwords($state['name'])); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="js-example-basic-single js-states form-control" id="city" name="city">
                        ...
                        <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php echo e(isset($stepTwo['city']) && $stepTwo['city'] == $city['id'] ? "selected" : null); ?>

                                value="<?php echo e($city['id']); ?>"><?php echo e(ucwords($city['name'])); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="postal_code" name="postal_code" placeholder=""
                        value="<?php echo e($stepTwo['postal_code'] ?? null); ?>">
                </div>
                <div class="form-group">
                    <label for="address" class="font-weight-bold">Address<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="address" name="address" placeholder="Apartment, suite, unit etc."
                        value="<?php echo e($stepTwo['address'] ?? null); ?>">
                </div>
                <div class="button-group d-flex pt-3 justify-content-between flex-wrap">
                    <button onclick="stepFormShow(1)" class="btn btn-outline"><i class="mr-2 ri-arrow-left-s-line"></i>Previous</button>
                    <button type="submit" id="stepTwo" class="btn btn-accent">Save &amp; Next<i class="ml-2 ri-arrow-right-s-line"></i></button>
                </div>
            </div>
        </div>
    </form>
...
<?php echo $__env->make("auth.publisher_register.base", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\lynktrix\resources\views/auth/publisher_register/step_two.blade.php ENDPATH**/ ?>