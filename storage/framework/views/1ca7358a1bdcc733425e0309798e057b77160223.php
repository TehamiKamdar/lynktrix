                            ...
                            <div class="ap-img d-flex justify-content-center">
                                ...
                                <a href="<?php echo e(route("publisher.view-advertiser", ['sid' => $advertiser->sid])); ?>">
                                 ...
                                 <?php if(!empty($advertiser->fetch_logo_url)): ?>
                                   <img loading="lazy" class="ap-img__main w-auto h-40 mb-3" src="<?php echo e($advertiser->fetch_logo_url); ?>" alt="<?php echo e($advertiser->name); ?>" style="max-width: 200px !important;">

                                   <?php elseif(!empty($advertiser->logo)): ?>
                                   <img loading="lazy" class="ap-img__main w-auto h-40 mb-3" src="<?php echo e(\App\Helper\Static\Methods::staticAsset("$advertiser->logo")); ?>"
        alt="<?php echo e($advertiser->name); ?>" style="max-width: 200px !important;">
                                   <?php else: ?>

                                   <img loading="lazy" class="ap-img__main w-auto h-40 mb-3" src="<?php echo e(\App\Helper\Static\Methods::isImageShowable($advertiser->logo)); ?>" alt="<?php echo e($advertiser->name); ?>" style="max-width: 200px !important;">
                                <?php endif; ?>
                               </a>
                            </div>
                            <div class="ap-nameAddress">
                                <a href="<?php echo e(route("publisher.view-advertiser", ['sid' => $advertiser->sid])); ?>">
                                    <h6 class="ap-nameAddress__title"><?php echo e($advertiser->name); ?></h6>
                                </a>
                                <p class="ap-nameAddress__subTitle  fs-14 pt-1 m-0 ">
                                    <a href="<?php echo e($advertiser->url); ?>" target="_blank">
                            ...
                            <div class="ap-button account-profile-cards__button button-group d-flex justify-content-center flex-wrap pt-20">
                                ...
                                <button type="button" class="border text-capitalize px-2 color-gray transparent shadow2 radius-md drawer-trigger" data-drawer="account" onclick="pushInfo('<?php echo e($advertiser->id); ?>', '<?php echo e($advertiser->name); ?>')">
                                ...
                                <?php else: ?>
                                    ...
                                    <button type="button" class="btn btn-default btn-squared btn-outline-success text-capitalize px-25 shadow2 follow radius-md" data-toggle="modal" data-target="#modal-basic" onclick="openApplyModal('<?php echo e($advertiser->sid); ?>', `<?php echo e($advertiser->name); ?>`)">
                        ...
                        <div class="card-footer mt-20 pt-20 pb-10 px-0">
                            ...
                            <div class="profile-overview d-flex justify-content-between flex-wrap">
                                <div class="po-details">
                                    <h6 class="po-details__title"><?php if($advertiser->commission): ?><?php echo e($advertiser->commission); ?><?php echo e($advertiser->commission_type == "percentage" ? "%" : $advertiser->commission_type); ?><?php else: ?> - <?php endif; ?></h6>
                                ...
                                <div class="po-details">
                                    <h6 class="po-details__title"><?php echo e($advertiser->average_payment_time ?? "-"); ?> <span class="fs-12">days</span></h6>
...
<?php endif; ?>
<?php /**PATH C:\Users\lenovo\Downloads\application\resources\views/template/publisher/advertisers/advertiser-grid.blade.php ENDPATH**/ ?>