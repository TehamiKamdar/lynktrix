<header class="header-top">
    <nav class="navbar navbar-light">
        <div class="navbar-left">
            <a class="navbar-brand" href="<?php echo e(route("dashboard", ["type" => \App\Helper\Static\Vars::ADMIN_ROUTE])); ?>">
                <?php if(env("APP_ENV") == "production"): ?>
                    <img class="dark" src="<?php echo e(asset("img/logo.png")); ?>" alt="svg">
                    <img class="light" src="<?php echo e(asset("img/logo.png")); ?>" alt="img">
                <?php endif; ?>
            </a>
            <div class="top-menu">
        ...
        <div class="navbar-right">
            <ul class="navbar-right__menu">
                ...
                <li class="nav-author">
                    <div class="dropdown-custom">
                        <a href="javascript:;" class="nav-item-toggle"><img src="<?php echo e(\App\Helper\Static\Methods::staticAsset("img/author-nav.jpg")); ?>" alt="" class="rounded-circle"></a>
                        <div class="dropdown-wrapper">
                            <div class="nav-author__info">
                                <div class="author-img">
                                    <img src="<?php echo e(\App\Helper\Static\Methods::staticAsset("img/author-nav.jpg")); ?>" alt="" class="rounded-circle">
                                </div>
                                <div>
                                    <h6><?php echo e(auth()->user()->full_name); ?></h6>
                                    <span><?php echo e(auth()->user()->getRoleName()); ?></span>
                                </div>
                            </div>
...
<?php /**PATH C:\Users\lenovo\Downloads\application\resources\views/partial/admin/header.blade.php ENDPATH**/ ?>