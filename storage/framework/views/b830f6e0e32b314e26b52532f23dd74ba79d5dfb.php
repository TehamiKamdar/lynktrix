<?php if (! $__env->hasRenderedOnce('5c07a576-bd2d-43ab-b8e5-91ce8aed4066')): $__env->markAsRenderedOnce('5c07a576-bd2d-43ab-b8e5-91ce8aed4066');
...
.ps-30 .ps__thumb-x {
  ...
  <!-- Icon fonts -->
    <link rel="stylesheet" href="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/fonts/fontawesome.css")); ?>">
    <link rel="stylesheet" href="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/fonts/ionicons.css")); ?>">
    <link rel="stylesheet" href="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/fonts/linearicons.css")); ?>">
    <link rel="stylesheet" href="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/fonts/open-iconic.css")); ?>">
    <link rel="stylesheet" href="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/fonts/pe-icon-7-stroke.css")); ?>">
    <link rel="stylesheet" href="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/fonts/feather.css")); ?>">
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    <!-- Core stylesheets -->
    <link rel="stylesheet" href="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/css/bootstrap-materials.css")); ?>">
    <link rel="stylesheet" href="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/css/shreerang-materials.css")); ?>">
    <link rel="stylesheet" href="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/css/uikit.css")); ?>">

    <!-- Libs -->
    <link rel="stylesheet" href="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/libs/perfect-scrollbar/perfect-scrollbar.css")); ?>">
    <link rel="stylesheet" href="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/libs/flot/flot.css")); ?>">
    <style>
...
<?php if (! $__env->hasRenderedOnce('b43fafaf-0503-4ff7-912e-f619f3f500e4')): $__env->markAsRenderedOnce('b43fafaf-0503-4ff7-912e-f619f3f500e4');
$__env->startPush('scripts'); ?>
 <?php
        ...
        ?>
 <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/js/pace.js")); ?>"></script>
 <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("vendor_assets/js/charts.js")); ?>"></script>
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/libs/popper/popper.js")); ?>"></script>
  
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/js/sidenav.js")); ?>"></script>
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/js/layout-helpers.js")); ?>"></script>
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/js/material-ripple.js")); ?>"></script>

    <!-- Libs -->
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/libs/perfect-scrollbar/perfect-scrollbar.js")); ?>"></script>
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/libs/eve/eve.js")); ?>"></script>
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/libs/flot/flot.js")); ?>"></script>
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/libs/flot/curvedLines.js")); ?>"></script>
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/libs/chart-am4/core.js")); ?>"></script>
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/libs/chart-am4/charts.js")); ?>"></script>
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/libs/chart-am4/animated.js")); ?>"></script>
   ...
   <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("vendor_assets/js/moment/moment.min.js")); ?>"></script>
    ...
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/js/analytics.js")); ?>"></script>
    <script src="<?php echo e(\App\Helper\Static\Methods::staticAsset("dashboard_assets/js/pages/dashboards_index.js")); ?>"></script>
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
    ...
    <script type="text/javascript">
                ...
                $('input[name="date-ranger"]').daterangepicker({
                    ...
                    ranges: {
                        ...
                        'Over All': [moment('2022-01-01'), moment().endOf('year')]
                    },
                });
...
<?php $__env->stopPush(); endif; ?>
  <script>
    let graph =<?php echo json_encode($earningSummaryGraph, 15, 512) ?>;
</script>
...
<div class="contents">
    ...
    <!-- [ Layout container ] Start -->
      ...
      <?php if(auth()->user()->type != 'staff'): ?>
                        <div class="row">
                                    ...
                                    <div class="card-header with-elements">
                                        ...
                                        <div class="card-header-elements ml-auto">
                                            <label class="text m-0">
                                                ...
                                                <span class="switcher switcher-sm d-inline-block align-middle mr-0 ml-2"><input type="checkbox" class="switcher-input" id="switcher-input"><span class="switcher-indicator"><span class="switcher-yes"></span><span
                            ...
                            <div class="col-lg-5">
                                <div class="row" id="show-stats-digit">
                                    <div class="col-md-6">
                                            ...
                                            <div class="card-body" id="total_sales" onclick="show_graph('total_sales',graph)">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ml-3">
                                                        ...
                                                        <div class="text-large">$ <?php echo e(number_format($earningSummary['total_sales'],2)); ?></div>
                                                    </div>
                                                ...
                                                <div>
                                                     <?php if($earningSummaryComparison['total_sales']['change_percent'] < 0): ?>
                                                    <p class="progress-downword">
                                <strong>
                                    <span class="la la-arrow-down"></span>
                                    <?php echo e($earningSummaryComparison['total_sales']['change_percent']); ?>%
                                </strong>
                                            ...
                                            <div class="card-body" id="total_commission" onclick="show_graph('total_commission',graph)">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ml-3">
                                                        ...
                                                        <div class="text-large">$ <?php echo e(number_format($earningSummary['total_commission'],2)); ?></div>
                                                    </div>
                                                    
                                                </div>
                                                 
                                                <div>
                                                    <?php if($earningSummaryComparison['total_commission']['change_percent'] < 0): ?>
                                                    <p class="progress-downword">
                                <strong>
                                    <span class="la la-arrow-down"></span>
                                    <?php echo e($earningSummaryComparison['total_commission']['change_percent']); ?>%
                                </strong>
                                From Previous Period
                            </p>
                                                    <?php else: ?>
                                            ...
                                            <div class="card-body" id="total_transactions" onclick="show_graph('total_transactions',graph)">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ml-3">
                                                        ...
                                                        <div class="text-large"><?php echo e($earningSummary['total_transactions']); ?></div>
                                                    </div>
                                                    
                                                </div>
                                                 
                                                <div>
                                                    <?php if($earningSummaryComparison['total_transactions']['change_percent'] < 0): ?>
                                                    <p class="progress-downword">
                                <strong>
                                    <span class="la la-arrow-down"></span>
                                    <?php echo e($earningSummaryComparison['total_transactions']['change_percent']); ?>%
                                </strong>
                                From Previous Period
                            </p>
                                                    <?php else: ?>
                                            ...
                                            <div class="card-body" id="total_revenue" onclick="show_graph('total_revenue',graph)">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ml-3">
                                                        ...
                                                        <div class="text-large">$ <?php echo e(number_format($earningSummary['total_profit'],2)); ?></div>
                                                    </div>
                                                    
                                                </div>
                                                 
                                                <div>
                                                    <?php if($earningSummaryComparison['total_profit']['change_percent'] < 0): ?>
                                                    <p class="progress-downword">
                                <strong>
                                    <span class="la la-arrow-down"></span>
                                    <?php echo e($earningSummaryComparison['total_profit']['change_percent']); ?>%
                                </strong>
                                From Previous Period
                            </p>
                                                    <?php else: ?>
                                            ...
                                            <div class="row no-gutters row-bordered row-border-light h-100">
                                                <div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center" onclick="show_graph('pending_commission',graph)">
                                                    <div class="card-body media align-items-center text-dark">
                                                        ...
                                                        <span class="media-body d-block ml-3"><span class="text-big mr-1 text-primary">$ <?php echo e(number_format($earningSummary['pending_commission'],2)); ?></span>
                                                            <br>
                                                ...
                                                <div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center" onclick="show_graph('approved_commission',graph)">
                                                    <div class="card-body media align-items-center text-dark">
                                                        ...
                                                        <span class="media-body d-block ml-3"><span class="text-big"><span class="mr-1 text-primary">$ <?php echo e(number_format($earningSummary['approved_commission'],2)); ?></span></span>
                                                            <br>
                                                ...
                                                <div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center" onclick="show_graph('declined_commission',graph)">
                                                    <div class="card-body media align-items-center text-dark">
                                                        ...
                                                        <span class="media-body d-block ml-3"><span class="text-big"><span class="mr-1 text-primary">$ <?php echo e(number_format($earningSummary['declined_commission'],2)); ?></span></span>
                                                            <br>
                                                ...
                                                <div class="d-flex col-sm-6 col-md-4 col-lg-6 align-items-center">
                                                    <div class="card-body media align-items-center text-dark">
                                                        ...
                                                        <span class="media-body d-block ml-3"><span class="text-big"><span class="mr-1 text-primary">$ <?php echo e($earningSummary['totalPaidAmount']); ?></span></span>
                                                            <br>
                                            ...
                                            <div class="card-body">
                                                <div class="row align-items-center mb-3">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <h4 class="mt-3 mb-0"><?php echo e($advertisersStats['totalAdvertisers']); ?></h4>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row align-items-center mb-3">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <h4 class="mt-3 mb-0"><?php echo e($advertisersStats['totalActiveAdvertisers']); ?></h4>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row align-items-center mb-3">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <h4 class="mt-3 mb-0"><?php echo e($advertisersStats['totalNewAdvertisers']); ?></h4>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row align-items-center mb-3">
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <h4 class="mt-3 mb-0"><?php echo e($advertisersStats['totalPending']); ?></h4>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="nav-tabs-top">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="sale-stats1">
                                                <div style="height: 330px" id="tasks-inner" class="ps-30">
                                                    <table class="table table-hover card-table">
                                                        ...
                                                        <tbody id="TopPublisherCommissions">
                                                            
                                                        </tbody>
                                                    </table>
                                                     <div id="topPublisherLoaderWrapper">
        <span class="loader" id="topPublisherLoader"></span>
    </div>
                                                </div>
                                               
                                            </div>
                                            <div class="tab-pane fade" id="latest-sales1">
                                                <div style="height: 330px" id="tab-table-3" class="ps-30">
                                                    <table class="table table-hover card-table">
                                                        <thead>
                                                            <tr>
                                    ...
                                    <div class="nav-tabs-top">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="sale-stats">
                                                <div style="height: 330px" id="tab-table-1" class="ps-30">
                                                    <table class="table table-hover card-table">
                                                        <thead>
                                                            <tr>
                                                                <th></th>
                                                        ...
                                                        <tbody id="topAdvertisersCommission">
                                                            
                                                        </tbody>
                                                    </table>
                                                    <div id="topAdverisersLoaderWrapper">
        <span class="loader" id="topAdverisersLoader"></span>
    </div>
                                                </div>
                                               
                                            </div>
                                            <div class="tab-pane fade" id="latest-sales">
                                                <div style="height: 330px" id="tab-table-2" class="ps-30">
                                                    <table class="table table-hover card-table">
                                                        <thead>
                                                            <tr>
                                                                <th></th>
                         ...
                         <div class="row">
                            <div class="col-md-4">
                                <div class="card mb-4">
                                 ...
                                 <div style="height: 450px" id="tasks-inner2" class="ps-30">
                                                    <table class="table table-hover card-table">
                                                        <thead>
                                                            <tr>
                                                   ...
                                                   <div id="topClickLoaderWrapper">
        <span class="loader" id="topClickLoader"></span>
    </div>
                                                </div>
                                                 </div>
                                               </div>
                ...
                <div class="tab-pane fade active show" id="rb_device-today" role="tabpanel" aria-labelledby="rb_device-today-tab">
                    ...
                    <div class="revenue-chart-box-list" style="margin-left: 40px;margin-right: 40px;margin-bottom: 20px;">
                        <div class="revenue-chart-box justify-items-center" style="justify-items: center;">
                            ...
                            <div class="my-10">
                                <div class="revenue-chart-box__data">
                                    <?php echo e($trackingLinkComplete); ?>
                        ...
                        <div class="revenue-chart-box justify-items-center" style="justify-items: center;">
                            ...
                            <div class="my-10">
                                <div class="revenue-chart-box__data">
                                    <?php echo e($trackingLinkPending); ?>
                                    ...
                                    <div class="nav-tabs-top">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active" id="transaction-sale-stats">
                                                <div style="height: 330px" id="tab-table-4" class="ps-30">
                                                    <table class="table table-hover card-table">
                                                        <thead>
                                                            <tr>
                                                                <th></th>
                                                        ...
                                                        <tbody id="topTransactionstable">
                                                          
                                                        </tbody>
                                                    </table>
                                                     <span class="loader" id="topTransactionsLoader"></span>
                                                </div>
                                               
                                            </div>
                                            <div class="tab-pane fade" id="transaction-latest-sales">
                                                <div style="height: 330px" id="tab-table-5" class="ps-30">
                                                    <table class="table table-hover card-table">
                                                        <thead>
                                                            <tr>
                                                                <th></th>
                            ...
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="nav-tabs-top">
                                        <div class="tab-content">
                                            <div class="tab-pane fade show active">
                                                <div style="height: 440px" id="tab-table-6" class="ps-30">
 ...
 <?php endif; ?>
           ...
           <?php if (! $__env->hasRenderedOnce('aa167c9e-fa83-45c8-bc6d-4dce907a7a87')): $__env->markAsRenderedOnce('aa167c9e-fa83-45c8-bc6d-4dce907a7a87');
$__env->startPush('scripts'); ?>
<script>
    ...
    function show_graph(type, response) {
        ...
        if(type == 'approved_commission'){
            status = 'approved';
        }else if(type == 'pending_commission'){
            status = 'pending';
        }else if(type == 'declined_commission'){
            status = 'declined';
        }
        
        getTopTransactions(status);
                getTopPublishers(status);
                getTopAdvertisers(status);
       
    }

    $(document).ready(function () {
        let response = <?php echo json_encode($earningSummaryGraph, 15, 512) ?>;
         let status = '';
 ...
 $('#salesChart').css('display', 'none');
                          $('#show-stats-digit').css('display', 'none');
    
    chartjsPieExtra("chartDoughnut3Extra", "20", (data = [<?php echo e($trackingLinkComplete); ?>, <?php echo e($trackingLinkPending); ?>, <?php echo e($trackingLinkRetry); ?>]), ["Complete", "Pending", "Failed"]);
 chartjsDoughnutExtra("chartDoughnut4Extra", "20", (data = [<?php echo e($DeepLinkComplete); ?>, <?php echo e($DeepLinkPending); ?>, <?php echo e($DeepLinkRetry); ?>]), ["Complete", "Pending", "Failed"]);
    });


    function getTopClicks() {
    const urlParams = new URLSearchParams(window.location.search);
    let startDate = urlParams.get('start_date');
    let endDate = urlParams.get('end_date');
    let islimit = urlParams.get('islimit');
    ...
    $.ajax({
        url: '<?php echo e(route('admin.topClicks')); ?>',
        method: 'GET',
        data: {
        ...
        success: function (response) {
           ...
           let data = response.topClick;
           let html = '';
           for(i = 0 ; i < data.length; i++){
                html += `<tr>
                                                                 
                                                                <td class="align-middle">
                                                                    <a href="javascript:" class="text-dark">${data[i].country}</a>
                                                                </td>
                                                                <td class="align-middle">${data[i].total_clicks}</td>
                                                                 
                                                            </tr>`
           }

           document.getElementById('topClicksTable').innerHTML = html;
           countryGraph(data);
           document.getElementById('topClickLoader').style.display = 'none';
           document.getElementById('topClickLoaderWrapper').style.display = 'none';
        },
        error: function (xhr) {
...
function getTopAdvertisers(status){
      const urlParams = new URLSearchParams(window.location.search);
    let startDate = urlParams.get('start_date');
    let endDate = urlParams.get('end_date');
    let islimit = urlParams.get('islimit');
...
lastDay.setDate(lastDay.getDate() + 1);
    ...
    $.ajax({
        url: '<?php echo e(route('admin.topAdvertisers')); ?>',
        method: 'GET',
        data: {
            start_date: startDate,
            end_date: endDate,
        ...
        success: function (response) {
            ...
            let topSales = response.topSales;
            let sales = '';
            for (let i = 0; i < topSales.length; i++) {
    let a = topSales[i];
   let logoUrl = '';
    if (a.fetch_logo_url) {
        logoUrl = a.fetch_logo_url;
    } else if (a.logo) {
        logoUrl = "https://app.linkscircle.com" + (a.logo.startsWith("/") ? a.logo : "/" + a.logo); // replace with correct path if needed
    } else {
        logoUrl = '/placeholder-image.jpg'; // fallback image
    }
    if (a.fetch_logo_url) {
        logo = `<img loading="lazy" class="ap-img__main h-auto mr-10" src="${logoUrl}" alt="${a.advertiser_name}" style="width: 50px">`;
    } else if (a.logo) {
        logo = `<img loading="lazy" class="ap-img__main h-auto mr-10" src="${logoUrl}" alt="${a.advertiser_name}" style="width: 60px">`;
    } else {
        logo = `<img loading="lazy" class="ap-img__main h-auto mr-10" src="${logoUrl}" alt="${a.advertiser_name}" style="width: 50px">`;
    }
    ...
    sales += `
        <tr>
            ...
            <td class="align-middle">${Number(a.total_sales_amount).toFixed(2)}</td>
            <td class="align-middle">${a.total_transactions}</td>
        </tr>
    `;
}

            document.getElementById('topAdvertisersSale').innerHTML = sales


             let topCommissions = response.topCommissions;
           let Commissions = '';
for (let i = 0; i < topCommissions.length; i++) {
    let a = topCommissions[i];
   let logoUrl = '';
    if (a.fetch_logo_url) {
        logoUrl = a.fetch_logo_url;
    } else if (a.logo) {
    ...
    Commissions += `
        <tr>
            ...
            <td class="align-middle">${Number(a.total_commission_amount).toFixed(2)}</td>
            <td class="align-middle">${a.total_transactions}</td>
        </tr>
    `;
}

            document.getElementById('topAdvertisersCommission').innerHTML = Commissions
document.getElementById('topAdverisersLoaderWrapper').style.display = 'none';
            document.getElementById('topAdverisersLoader').style.display = 'none';
             },
        error: function (xhr) {
            console.error('Error:', xhr.responseText);
        }
...
function getTopPublishers(status){
     const urlParams = new URLSearchParams(window.location.search);
    let startDate = urlParams.get('start_date');
    let endDate = urlParams.get('end_date');
    let islimit = urlParams.get('islimit');

      // If no dates OR if invalid dates from query string
    if (!startDate || !endDate) {
        const now = new Date();
        const firstDay = new Date(now.getFullYear(), now.getMonth(), 1);
        const lastDay = new Date(now.getFullYear(), now.getMonth() + 1, 0);
...
lastDay.setDate(lastDay.getDate() + 1);
    ...
    $.ajax({
        url: '<?php echo e(route('admin.topPublsihers')); ?>',
        method: 'GET',
        data: {
            start_date: startDate,
            end_date: endDate,
        ...
        success: function (response) {
            ...
            for(i = 0; i < topSales.length; i++){
                ...
                sales += `<tr>
                                                                ...
                                                                <td class="align-middle">
                                                                    <a href="javascript:" class="text-dark">${a.name}</a>
                                                                </td>
                                                                <td class="align-middle">${parseFloat(a.total_sales_amount).toFixed(2)}</td>
                                                                 <td class="align-middle">${a.total_transactions}</td>
                                                            </tr>`
            }

            document.getElementById('TopPublisherSales').innerHTML = sales


             let topCommissions = response.topCommissions;
            let Commissions = '';
            for(i = 0; i < topCommissions.length; i++){
                let ab = topCommissions[i];
                Commissions += `<tr>
                                                                 
                                                                <td class="align-middle">
                                                                    <a href="javascript:" class="text-dark">${ab.name}</a>
                                                                </td>
                                                                <td class="align-middle">${parseFloat(ab.total_commission_amount).toFixed(2)}</td>
                                                                 <td class="align-middle">${ab.total_transactions}</td>
                                                            </tr>`
            }

            document.getElementById('TopPublisherCommissions').innerHTML = Commissions

            document.getElementById('topPublisherLoader').style.display = 'none';
            document.getElementById('topPublisherLoaderWrapper').style.display = 'none';
             },
        error: function (xhr) {
            console.error('Error:', xhr.responseText);
        }
...
function getTopTransactions(status) {
    const urlParams = new URLSearchParams(window.location.search);
    let startDate = urlParams.get('start_date');
    let endDate = urlParams.get('end_date');
    let islimit = urlParams.get('islimit');
...
lastDay.setDate(lastDay.getDate() + 1);
    ...
    $.ajax({
        url: '<?php echo e(route('admin.topTransactions')); ?>',
        method: 'GET',
        data: {
            start_date: startDate,
            end_date: endDate,
        ...
        success: function (response) {
           ...
           let topTransactions = response.topTransactions;
           let top = '';
for (let i = 0; i < topTransactions.length; i++) {
    const a = topTransactions[i];
    ...
    if (a.fetch_logo_url) {
        ...
        logoUrl = '/path-to-placeholder-image.jpg'; // fallback image
    }

    top += `<tr>
        <td>
            <img loading="lazy" class="ap-img__main h-auto mr-10" src="${logoUrl}" alt="${a.advertiser_name}" style="width: 50px">
        </td>
        <td class="align-middle">
            <a href="javascript:" class="text-dark">${a.advertiser_name}</a>
        </td>
        ...
        <td class="align-middle">${parseFloat(a.sale_amount).toFixed(2)}</td>
        <td class="align-middle">${parseFloat(a.commission_amount).toFixed(2)}</td>
    </tr>`;
}

           document.getElementById('topTransactionstable').innerHTML = top;

let latestTransactions = response.latestTransactions;
           let latest = '';
for (let i = 0; i < latestTransactions.length; i++) {
    const a = latestTransactions[i];
    ...
    latest += `<tr>
        ...
        <td class="align-middle">${parseFloat(a.commission_amount).toFixed(2)}</td>
           ...
           document.getElementById('latestTransactionstable').innerHTML = latest;

           document.getElementById('topTransactionsLoader').style.display = 'none';
           document.getElementById('topTransactionsLoaderWrapper').style.display = 'none';
        },
        error: function (xhr) {
            console.error('Error:', xhr.responseText);
        }
...
function countryGraph(data){
 const countryClicks = {};
    data.forEach(item => {
        countryClicks[item.country] = item.total_clicks;
    });
        ...
        $('#islimit, #islimit1, #islimit2, #islimit3, #islimit5').on('change', function () {
                ...
                $('#switcher-input').on('change',function(){
                    ...
                    if(checked){
                       ...
                       $('#show-stats-digit').css('display', 'flex');
                    }else{
...
<?php echo $__env->make("layouts.admin.panel_app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Downloads\application\resources\views/template/admin/dashboard.blade.php ENDPATH**/ ?>