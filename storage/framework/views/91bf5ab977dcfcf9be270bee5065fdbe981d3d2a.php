                ...
                <div class="col-xl-4 col-lg-5 col-md-5 p-0">
                    <div class="signUP-admin-left signIn-admin-left position-relative">
                        <div class="signUP-overlay">
                            <img class="svg signupTop" src="<?php echo e(asset('img/svg/signuptop.svg')); ?>" alt="img"/>
                            <img class="svg signupBottom" src="<?php echo e(asset('img/svg/signupbottom.svg')); ?>" alt="img"/>
                        </div><!-- End: .signUP-overlay  -->
                        <div class="signUP-admin-left__content">
                            <div class="logo-div">
                                <a href="https://www.linkscircle.com/"><img src="<?php echo e(\App\Helper\Static\Methods::staticAsset("img/logo.png")); ?>" alt="LinksCircle Affiliate Network" class="img-fluid"></a>
                            </div>
...
<?php echo $__env->make("layouts.panel_guest", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\lenovo\Downloads\application\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>