...
const customTooltips = function (tooltip) {
    ...
    const parent = this._chart.canvas.closest(".parentContainer");

    // 🔍 Get / create tooltip element (scoped per chart)
    ...
    if (tooltip.body) {
        ...
        bodyLines.forEach(function (body, i) {
            ...
            style += `; border-width:2px; border-radius:50%`;
    ...
    if (left + tooltipWidth > parentWidth - 8) {
        left = parentWidth - tooltipWidth - 8;
    }
...
function chartjsLineChartForcast(
    selector,
    label = "",
    startGradient = "#C2243712",
    endGradient = "#C2243702",
    bColor = "#20C997",
            ...
            var chart = new Chart(elm, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        // backgroundColor: bgColor,
                        borderColor: bColor,
                        pointHoverBackgroundColor: "#C22437",
...
/* line chart four */
function chartjsLineChartFive(selector, bcolor = "#FA8B0C", height = "95", dataCur, labels, suggestedMin = 50, suggestedMax = 80) {
    var ctxs = document.getElementById(selector);
    if (ctxs) {
        ctxs.getContext("2d");
        ctxs.height = window.innerWidth <= 575 ? 190 : height;
    ...
    if (ctx) {
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: dataG,
                    backgroundColor: "#C2243780",
                    hoverBackgroundColor: "#C22437",
                    label: "Gained",
                },
                    // {
                    //   data: dataL,
...
function chartjsPieExtra(selector, cHeight, data, labels) {
    var ctx = document.getElementById(selector);
    if (ctx) {
        ctx.getContext("2d");
        ctx.height = cHeight;
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: data,
                    backgroundColor: ["#20C997", "#ca9a4e", "#FA8B0C"],
                }],
            },
            options: {
                maintainAspectRatio: true,
...
chartJsBarChartThree("mychart8", "#C2243720", "#C22437", "Order");
...
chartJsBarChartFour("mychart13", "#C2243720", "#C22437", "New Deals");
    ...
    if (ctx) {
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    data: data,
                    backgroundColor: ["#20C997", "#C22437", "#FA8B0C"],
                    total: "9,283",
                }, ],
            },
            options: {
...
function chartjsDoughnutExtra(selector, cHeight, data, labels) {
    var ctx = document.getElementById(selector);
    if (ctx) {
        ctx.getContext("2d");
        ctx.height = cHeight;
